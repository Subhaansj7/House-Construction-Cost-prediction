...
l1 = tk.Label(window, text="Registration Form", font=("Times new roman", 30, "bold"), bg="#6495ED", fg="black")
l1.place(x=590, y=50)
...
btn = tk.Button(window, text="Register", bg="#6495ED",font=("",20),fg="black", width=9, height=1, command=insert)
btn.place(x=630, y=620)
